App.build_settings = () => {
  ...
  props = {
    autoclick_delay: {
      name: `Autoclick Delay`,
      type: `number`,
      value: 500,
      placeholder: `Number`,
      min: App.number_min,
      max: App.number_max,
      info: `Delay in milliseconds for auto-clicks`,
      version: 1,
    },
    item_autoclick: {
      name: `Item Autoclick`,

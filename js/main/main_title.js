...
App.create_main_title = () => {
  ...
  let btn_left = DOM.create(`div`, `main_title_button autoclick`, `main_title_left_button`)
  let btn_right = DOM.create(`div`, `main_title_button autoclick`, `main_title_right_button`)

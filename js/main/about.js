...
App.about_lore = `Grasshoppers are a group of insects belonging to the suborder Caelifera. They are among what is possibly the most ancient living group of chewing herbivorous insects, dating back to the early Triassic around 250 million years ago.
...
App.start_about_lore = () => {
  ...
  App.create_window({
    ...
    setup: () => {
      ...
      lore.textContent = App.about_lore
      let s = `${App.manifest.name} v${App.manifest.version}`

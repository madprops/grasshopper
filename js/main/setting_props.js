App.build_settings = () => {
  ...
  props = {
    ...
    hover_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `filter_domain`, _id_: `00_1`},
        {cmd: `filter_color`, _id_: `00_2`},
        {cmd: `duplicate_tabs`, _id_: `00_3`},
        {cmd: `unload_tabs`, _id_: `00_4`},
      ],
    ...
    extra_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `open_new_tab`, alt: `insert_header`, _id_: `00_1`},
        {cmd: `add_jump_tag_1`, alt: `remove_jump_tag_1`, _id_: `00_2`},
      ],
    ...
    pinline_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `new_pinned_tab`, _id_: `00_1`},
        {cmd: `select_pinned_tabs`, _id_: `00_2`},
        {cmd: `select_normal_tabs`, _id_: `00_3`},
        {cmd: `select_unloaded_tabs`, _id_: `00_4`},
        {cmd: `select_all_items`, _id_: `00_5`},
      ],
    ...
    tabs_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `open_new_tab`, _id_: `00_1`},
        {cmd: `reopen_tab`, _id_: `00_2`},
        {cmd: `sort_tabs`, _id_: `00_3`},
        {cmd: `show_tabs_info`, _id_: `00_4`},
        {cmd: `show_tab_urls`, _id_: `00_5`},
        {cmd: `open_tab_urls`, _id_: `00_6`},
        {cmd: `show_close_tabs_menu`, _id_: `00_7`},
      ],
    ...
    history_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `deep_search`, _id_: `00_1`},
        {cmd: `show_search_media_menu`, _id_: `00_2`},
      ],
    ...
    empty_menu: {
      ...
      value: [
        {cmd: `open_new_tab`, _id_: `00_1`},
        {cmd: `reopen_tab`, _id_: `00_2`},
        {cmd: `select_all_items`, _id_: `00_3`},
      ],
      separator: true,
  ...
  props = {
    ...
    footer_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `copy_item_url`, _id_: `00_1`},
        {cmd: `copy_item_title`, _id_: `00_2`},
      ],
  ...
  props = {
    ...
    favorites_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `show_recent_tabs`, alt: `filter_unread_tabs`, _id_: `00_1`},
        {cmd: `show_pinned_tabs`, alt: `filter_pinned_tabs`, _id_: `00_2`},
        {cmd: `show_color_red`, alt: `filter_color_red`, _id_: `00_3`},
        {cmd: `show_color_green`, alt: `filter_color_green`, _id_: `00_4`},
        {cmd: `show_color_blue`, alt: `filter_color_blue`, _id_: `00_5`},
        {cmd: `set_random_dark_colors`, alt: `set_random_light_colors`, _id_: `00_6`},
        {cmd: `edit_notes`, alt: `edit_global_notes`, _id_: `00_7`},
        {cmd: `toggle_auto_blur`, alt: `toggle_favorites_autohide`, _id_: `00_8`},
      ],
  ...
  props = {
    ...
    main_title_menu: {
      ...
      type: `list`,
      value: [
        {cmd: `edit_main_title`, _id_: `00_1`},
        {cmd: `toggle_main_title_date`, _id_: `00_2`},
        {cmd: `color_main_title_red`, _id_: `00_3`},
        {cmd: `color_main_title_green`, _id_: `00_4`},
        {cmd: `color_main_title_blue`, _id_: `00_5`},
        {cmd: `uncolor_main_title`, _id_: `00_6`},
        {cmd: `settings_category_title`, _id_: `00_7`},
      ],
  ...
  props = {
    ...
    custom_filters: {
      ...
      type: `list`,
      value: [
        {filter: `re: (today|$day)`, _id_: `00_1`},
        {filter: `re: ($month|$year)`, _id_: `00_2`},
      ],
    ...
    refine_filters: {
      ...
      type: `list`,
      value: [
        {cmd: `filter_media_image`, _id_: `00_1`},
        {cmd: `filter_media_video`, _id_: `00_2`},
        {cmd: `filter_media_audio`, _id_: `00_3`},
      ],

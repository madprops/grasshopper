App.build_settings = () => {
  ...
  obj.wrap_text = {value: false, category: category, type: `checkbox`,
  ...
  obj.text_mode = {value: `title`, category: category, type: `menu`,
  name: `Text Mode`, version: 1,
  info: `What to show as the text for each item`}

  obj.item_height = {value: `normal`, category: category, type: `menu`,
  name: `Item Height`, version: 1,
  info: `How tall each item should be`}

  obj.item_border = {value: `none`, category: category, type: `menu`,
  ...
  obj.auto_restore = {value: `1_seconds`, category: category, type: `menu`,
  ...
  obj.background_color = {value: App.dark_colors.background, category: category, type: `color`,
  name: `Background Color`, action: `theme`, version: 1,
  info: `The background color`}

  obj.text_color = {value: App.dark_colors.text, category: category, type: `color`,
  name: `Text Color`, action: `theme`, version: 1,
  info: `The text color`}

  obj.background_image = {value: `Background 1`, category: category, type: `text`,
  ...
  obj.gestures_enabled = {value: true, category: category, type: `checkbox`,
  name: `Gestures Enabled`, version: 1,
  info: `Enable mouse gestures`}

  obj.gestures_threshold = {value: 10, category: category, type: `menu`,
  name: `Gestures Threshold`, version: 1,
  info: `How sensitive gestures are`}

  obj.gesture_up = {value: `go_to_top`, category: category, type: `menu`,
  name: `Gesture Up`, version: 1,
  info: `Up gesture`}

  obj.gesture_down = {value: `go_to_bottom`, category: category, type: `menu`,
  name: `Gesture Down`, version: 1,
  info: `Down gesture`}

  obj.gesture_left = {value: `prev_mode`, category: category, type: `menu`,
  name: `Gesture Left`, version: 1,
  info: `Left gesture`}

  obj.gesture_right = {value: `next_mode`, category: category, type: `menu`,
  name: `Gesture Right`, version: 1,
  info: `Right gesture`}

  obj.gesture_up_and_down = {value: `show_all_items`, category: category, type: `menu`,
  name: `Gesture Up Down`, version: 1,
  info: `Up and Down gesture`}

  obj.gesture_left_and_right = {value: `filter_domain`, category: category, type: `menu`,
  ...
  obj.middle_click_tabs = {value: `close_tabs`, category: category, type: `menu`,
  name: `Middle-Click Tabs`, version: 1,
  info: `Middle-click on tab items`}

  obj.middle_click_history = {value: `open_items`, category: category, type: `menu`,
  name: `Middle-Click History`, version: 1,
  info: `Middle-click on history items`}

  obj.middle_click_bookmarks = {value: `open_items`, category: category, type: `menu`,
  name: `Middle-Click Bookmarks`, version: 1,
  info: `Middle-click on bookmark items`}

  obj.middle_click_closed = {value: `open_items`, category: category, type: `menu`,
  name: `Middle-Click Closed`, version: 1,
  info: `Middle-click on closed items`}

  obj.middle_click_main_menu = {value: `show_primary`, category: category, type: `menu`,
  name: `Middle-Click Main Menu`, version: 1,
  info: `Middle-click on the main menu`}

  obj.middle_click_filter_menu = {value: `show_all_items`, category: category, type: `menu`,
  name: `Middle-Click Filter Menu`, version: 1,
  info: `Middle-click on the filter menu`}

  obj.middle_click_back_button = {value: `browser_back`, category: category, type: `menu`,
  name: `Middle-Click Back Button`, version: 1,
  info: `Middle-click on the back button`}

  obj.middle_click_actions_menu = {value: `browser_reload`, category: category, type: `menu`,
  name: `Middle-Click Actions Menu`, version: 1,
  info: `Middle-click on the actions menu`}

  obj.middle_click_footer = {value: `copy_item_url`, category: category, type: `menu`,
  name: `Middle-Click Footer`, version: 1,
  info: `Middle-click on the footer`}

  obj.middle_click_pinline = {value: `close_normal_tabs`, category: category, type: `menu`,
  name: `Middle-Click Pinline`, version: 1,
  info: `Middle-click on the pinline`}

  obj.middle_click_close_icon = {value: `unload_tabs`, category: category, type: `menu`,
  ...
  obj.extra_menu = {value: [], category: category, type: `list`,
  ...
  obj.keyboard_shortcuts = {value: [], category: category, type: `list`,
  ...
  obj.warn_on_close_tabs = {value: `special`, category: category, type: `menu`,
  name: `Warn On Close Tabs`, version: 1,
  info: `When to warn on close tabs`}

  obj.warn_on_unload_tabs = {value: `special`, category: category, type: `menu`,
  name: `Warn On Unload Tabs`, version: 1,
  info: `When to warn on unload tabs`}

  obj.warn_on_close_normal_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Close Normal`, version: 1,
  info: `Warn when closing normal tabs using the close menu`}

  obj.warn_on_close_unloaded_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Close Unloaded`, version: 1,
  info: `Warn when closing unloaded tabs using the close menu`}

  obj.warn_on_close_duplicate_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Close Duplicates`, version: 1,
  info: `Warn when closing duplicate tabs using the close menu`}

  obj.warn_on_close_visible_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Close Visible`, version: 1,
  info: `Warn when closing visible tabs using the close menu`}

  obj.warn_on_duplicate_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn Duplicate Tabs`, version: 1,
  info: `Warn when duplicating tabs`}

  obj.warn_on_open = {value: true, category: category, type: `checkbox`,
  name: `Warn On Open`, version: 1,
  info: `Warn when opening items`}

  obj.warn_on_remove_profiles = {value: true, category: category, type: `checkbox`,
  name: `Warn On Remove Profiles`, version: 1,
  info: `Warn when removing profiles`}

  obj.warn_on_bookmark = {value: true, category: category, type: `checkbox`,
  name: `Warn On Bookmark`, version: 1,
  info: `Warn when adding bookmarks`}

  obj.warn_on_pin_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Pin Tabs`, version: 1,
  info: `Warn when pinning tabs`}

  obj.warn_on_unpin_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Unpin Tabs`, version: 1,
  info: `Warn when unpinning tabs`}

  obj.warn_on_load_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Load Tabs`, version: 1,
  info: `Warn when loading tabs`}

  obj.warn_on_mute_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Mute Tabs`, version: 1,
  info: `Warn when muting tabs`}

  obj.warn_on_unmute_tabs = {value: true, category: category, type: `checkbox`,
  name: `Warn On Unmute Tabs`, version: 1,
  info: `Warn when unmuting tabs`}

  obj.warn_on_color = {value: false, category: category, type: `checkbox`,
  name: `Warn On Color`, version: 1,
  info: `Warn when changing colors`}

  obj.warn_on_remove_color = {value: false, category: category, type: `checkbox`,
  ...
  obj.color_mode = {value: `border_icon`, category: category, type: `menu`,
  name: `Color Mode`, version: 2,
  info: `What color mode to use`}

  obj.color_red = {value: `rgb(172, 59, 59)`, category: category, type: `color`,
  name: `Color Red`, version: 1,
  info: `Color an item red`}

  obj.color_green = {value: `rgb(45, 115, 45)`, category: category, type: `color`,
  name: `Color Green`, version: 1,
  info: `Color an item green`}

  obj.color_blue = {value: `rgb(59, 59, 147)`, category: category, type: `color`,
  name: `Color Blue`, version: 1,
  info: `Color an item blue`}

  obj.color_yellow = {value: `rgb(200, 200, 88)`, category: category, type: `color`,
  name: `Color Yellow`, version: 1,
  info: `Color an item yellow`}

  obj.color_purple = {value: `rgb(124, 35, 166)`, category: category, type: `color`,
  name: `Color Purple`, version: 1,
  info: `Color an item purple`}

  obj.color_orange = {value: `rgb(189, 144, 74)`, category: category, type: `color`,
  ...
  obj.aliases = {value: [], category: category, type: `list`,
  ...
  obj.debug_mode = {value: false, category: category, type: `checkbox`,

App.build_settings = () => {
  ...
  props = {
    ...
    window_border_glow_hover: {
      name: `Border Glow Hover`,
      type: `checkbox`,
      value: false,
      actions: [`theme`],
      info: `Only show the border glow when hovering`,
      separator: true,
      version: 1,
    },
    auto_color_enabled: {
  ...
  props = {
    ...
    ...App.make_icon_settings({
      ...
      name: `Playing`,
      icon: `🔊`,
      info: `Icon for tabs emitting sound`,
      side: `left`,
      show: `always`,
  ...
  props = {
    ...
    ...App.make_mouse_settings({
      ...
      ctrl_click: `obfuscate_tabs`,
      shift_click: `none`,
      ctrl_shift_click: `none`,
      ctrl_middle_click: `none`,
  ...
  props = {
    ...
    ...App.make_mouse_settings({
      ...
      click_press: `show_favorite_filters`,
      middle_click_press: `show_custom_filters`,
  ...
  props = {
    ...
    compact_toggle_menu: {
      ...
      type: `checkbox`,
      value: false,
      info: `Only show icons in the Toggles Menu`,
      version: 1,
    },

App.build_settings = () => {
  ...
  props = {
    colors: {
      ...
      type: `list`,
      value: [
        {_id_: `red`, name: `Red`, value: `rgba(255, 0, 153, 0.7)`},
        {_id_: `green`, name: `Green`, value: `rgba(102, 204, 0, 0.7)`},
        {_id_: `blue`, name: `Blue`, value: `rgba(0, 153, 255, 0.7)`},
        {_id_: `yellow`, name: `Yellow`, value: `rgba(255, 153, 0, 0.7)`},
      ],

...
App.get_random_elements = (num = 1) => {
  App.load_elements()
  return App.get_random_items(App.elements, num)
}

App.get_random_element = () => {
  return App.get_random_elements(1)[0]
}
...
App.show_elements = (name = ``) => {
  ...
  if (name) {
    element = App.search_element(name)
  }

  if (!element) {
    element = App.get_random_element()
  }
...
App.search_element = (name, prop = `name`) => {
  let closest
  let highest = 0
